// ============================================================
// KPSS MATEMATİK SORU BANKASI
// ÖSYM müfredatına uygun, KPSS dışı konular çıkarılmıştır.
// Toplam ~3087 soru şablonu, 13 konu grubu
//
// Level 0:  Temel Aritmetik (Dört İşlem, Basamak, Ardışık)
// Level 1:  Sayılar (Bölünebilme, EBOB-EKOK, Asal, Faktöriyel)
// Level 2:  Kesirler
// Level 3:  Üslü ve Köklü Sayılar
// Level 4:  Çarpanlara Ayırma ve Özdeşlikler
// Level 5:  Denklemler (1.Derece, Sistemler, Denklem Kurma)
// Level 6:  Oran-Orantı-Yüzde
// Level 7:  Sözel Problemler (Yaş, Hız, İş, Karışım, Kâr-Zarar)
// Level 8:  Kümeler
// Level 9:  Permütasyon ve Kombinasyon
// Level 10: Olasılık
// Level 11: İstatistik (Ortalama, Medyan, Grafik)
// Level 12: Geometri (Açılar, Üçgenler, Dörtgenler, Çember)
// ============================================================

const SORU_BANKASI = {

  // ============================================================
  // LEVEL 0: TEMEL ARİTMETİK
  // ============================================================
0: [
...
2: [
  ...
  { id: "s3_rd_005", s: "({a}/{b} + {c}/{d})  { id: "t2_013", s: " {a}{r1}\n-{r2}{b}\n----\n {c}{d}\n{r1}+{r2} kaçtır?", c: "{r1}+{r2}", v: {a:[3,8], b:[1,7], r1:[1,9], r2:[1,8], kosul:"a>r2"}, z:"cok_zor", alt:"sifreli_cikarma" },
